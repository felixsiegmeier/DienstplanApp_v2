export default function RemoveAdminModal({ open, setOpen, isMobile, doctors, config }) {
    if (!open) return null;
        ...
        >
            ...
            >
                <div className="flex flex-col justify-center items-center gap-0">
                    <h1 className="text-lg font-bold mb-3">Admin entfernen</h1>
                    {doctors.map(doctor => (
                        (config.admins.includes(doctor._id) && (config.superAdmin !== doctor._id ))?
